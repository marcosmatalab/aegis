...
**Result** — one run over 29 attacks (every row's expectation is pinned to real pipeline behaviour by a self-consistency test):

| Bucket | OWASP 2025 | detection | passed |
|---|---|---|---|
| `prompt_injection` | LLM01 | 8/15 (0.533) | 7 |

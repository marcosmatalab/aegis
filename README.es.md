...
[![tests](https://img.shields.io/badge/tests-969%20passing-2ea44f?logo=pytest&logoColor=white)](#numeros)
...
|:-:|:-:|:-:|:-:|:-:|:-:|
| **969** | **96%** de rama | **κ 0,933** | **18/25** | **0,861** | **6** en `main` |
...
| 🧪 Suite de tests | **969 passed, 4 skipped**, 96% de cobertura de rama | `pytest -q --cov --cov-branch` | CI, `--cov-fail-under=95` |
...
pytest -q                 # 969 tests, ~10s, totalmente offline
